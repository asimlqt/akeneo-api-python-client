...
class ReferenceEntityMediaFileApi(object):
    ...
    def get_reference_entity_media_files_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_reference_entity_media_files_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_reference_entity_media_files_code`")  # noqa: E501
    ...
    def post_reference_entity_media_files_with_http_info(self, content_type, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_reference_entity_media_files" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('content_type' not in params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `post_reference_entity_media_files`")  # noqa: E501
