...
class MeasurementFamilyApi(object):
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method measurement_families_get_list" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_measurement_families(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_measurement_families(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[V1MeasurementfamiliesBody] body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_measurement_families_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.patch_measurement_families_with_http_info(**kwargs)  # noqa: E501
            return data

    def patch_measurement_families_with_http_info(self, **kwargs):  # noqa: E501
        """Update/create several measurement families  # noqa: E501

        This endpoint allows you to update and/or create several measurement families at once.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_measurement_families_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_measurement_families" % key
                )
            params[key] = val
        del params['kwargs']
