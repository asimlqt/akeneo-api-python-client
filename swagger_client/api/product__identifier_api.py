...
class ProductIdentifierApi(object):
    ...
    def delete_products_code(self, code, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_products_code_with_http_info(code, **kwargs)  # noqa: E501
            return data

    def delete_products_code_with_http_info(self, code, **kwargs):  # noqa: E501
        """Delete a product  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_products_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `delete_products_code`")  # noqa: E501
    ...
    def get_draft_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_draft_code`")  # noqa: E501
    ...
    def get_products_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_products_code" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_products_code`")  # noqa: E501
    ...
    def patch_products(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_products(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1ProductsBody1 body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_products_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.patch_products_with_http_info(**kwargs)  # noqa: E501
            return data

    def patch_products_with_http_info(self, **kwargs):  # noqa: E501
        """Update/create several products  # noqa: E501

        This endpoint allows you to update and/or create several products at once. Learn more about <a href=\"/documentation/update.html#update-behavior\">Update behavior</a>. Note that if no product exists for the given identifier, it creates it. In the Enterprise Edition, since the v2.0, permissions based on your user groups are applied to the products you try to update. It may result in the creation of drafts if you only have edit rights through the product's categories.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_products_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def patch_products_code(self, body, code, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_products_code(body, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProductsCodeBody body: (required)
        :param str code: Code of the resource (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_products_code_with_http_info(body, code, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_products_code_with_http_info(body, code, **kwargs)  # noqa: E501
            return data

    def patch_products_code_with_http_info(self, body, code, **kwargs):  # noqa: E501
        """Update/create a product  # noqa: E501

        This endpoint allows you to update a given product. Learn more about <a href=\"/documentation/update.html#update-behavior\">Update behavior</a>. Note that if no product exists for the given identifier, it creates it. In the Entreprise Edition, since the v2.0, permissions based on your user groups are applied to the product you try to update. It may result in the creation of a draft if you only have edit rights through the product's categories.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_products_code_with_http_info(body, code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_products_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_products_code`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `patch_products_code`")  # noqa: E501
    ...
    def post_products(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_products(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1ProductsBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_products_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_products_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_products_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new product  # noqa: E501

        This endpoint allows you to create a new product. In the Enterprise Edition, since the v2.0, permissions based on your user groups are applied to the product you try to create.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_products_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def post_proposal_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `post_proposal`")  # noqa: E501
