...
class PAMAssetTagApi(object):
    ...
    def get_asset_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PAMAssetTags',  # noqa: E501
    ...
    def get_asset_tags_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_asset_tags_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_asset_tags_code`")  # noqa: E501
    ...
    def patch_asset_tags_code(self, body, code, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_asset_tags_code(body, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AssettagsCodeBody body: (required)
        :param str code: Code of the resource (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_asset_tags_code_with_http_info(body, code, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_asset_tags_code_with_http_info(body, code, **kwargs)  # noqa: E501
            return data

    def patch_asset_tags_code_with_http_info(self, body, code, **kwargs):  # noqa: E501
        """Update/create a PAM asset tag  # noqa: E501

        This endpoint allows you to update a given PAM asset tag. Know more about <a href=\"/documentation/update.html#update-behavior\">Update behavior</a>. Note that if no tag exists for the given code, it creates it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_asset_tags_code_with_http_info(body, code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_asset_tags_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_asset_tags_code`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `patch_asset_tags_code`")  # noqa: E501
