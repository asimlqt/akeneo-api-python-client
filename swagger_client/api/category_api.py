...
class CategoryApi(object):
    ...
    def get_categories_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        if 'with_position' in params:
            query_params.append(('with_position', params['with_position']))  # noqa: E501
        if 'with_enriched_attributes' in params:
    ...
    def get_categories_code_with_http_info(self, authorization, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_categories_code" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_categories_code`")  # noqa: E501
    ...
    def get_category_media_files_code_download_with_http_info(self, authorization, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_category_media_files_code_download" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_category_media_files_code_download`")  # noqa: E501
    ...
    def patch_categories(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_categories_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.patch_categories_with_http_info(**kwargs)  # noqa: E501
            return data

    def patch_categories_with_http_info(self, **kwargs):  # noqa: E501
        """Update/create several categories  # noqa: E501

        This endpoint allows you to update several categories at once.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_categories_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_categories" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_categories_code(self, body, code, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_categories_code(body, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CategoriesCodeBody body: (required)
        :param str code: Code of the resource (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_categories_code_with_http_info(body, code, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_categories_code_with_http_info(body, code, **kwargs)  # noqa: E501
            return data

    def patch_categories_code_with_http_info(self, body, code, **kwargs):  # noqa: E501
        """Update/create a category  # noqa: E501

        This endpoint allows you to update a given category. Know more about <a href=\"/documentation/update.html#update-behavior\">Update behavior</a>. Note that if no category exists for the given code, it creates it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_categories_code_with_http_info(body, code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_categories_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_categories_code`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `patch_categories_code`")  # noqa: E501
    ...
    def post_categories(self, **kwargs):  # noqa: E501
        """Create a new category  # noqa: E501

        This endpoint allows you to create a new category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_categories(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1CategoriesBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_categories_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_categories_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_categories_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new category  # noqa: E501

        This endpoint allows you to create a new category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_categories_with_http_info(async_req=True)
        >>> result = thread.get()
