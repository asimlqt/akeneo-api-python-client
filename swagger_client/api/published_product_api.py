...
class PublishedProductApi(object):
    ...
    def get_published_products(self, **kwargs):  # noqa: E501
        ...
        :param str attributes: Filter published product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section
    ...
    def get_published_products_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_published_products" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='PublishedProducts',  # noqa: E501
    ...
    def get_published_products_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_published_products_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_published_products_code`")  # noqa: E501
