...
class LocaleApi(object):
    ...
    def get_locales(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_locales(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_locales_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_locales_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_locales_with_http_info(self, **kwargs):  # noqa: E501
        """Get a list of locales  # noqa: E501

        This endpoint allows you to get a list of locales. Locales are paginated and sorted by code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_locales_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_locales_code(self, code, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_locales_code_with_http_info(code, **kwargs)  # noqa: E501
            return data

    def get_locales_code_with_http_info(self, code, **kwargs):  # noqa: E501
        """Get a locale  # noqa: E501
