...
class MappingSchemaForProductsApi(object):
    ...
    def delete_app_catalogs_mapping_schema_product(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_app_catalogs_mapping_schema_product_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_app_catalogs_mapping_schema_product_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete the product mapping schema related to a catalog  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_app_catalogs_mapping_schema_product" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_app_catalogs_mapping_schema_product`")  # noqa: E501
    ...
    def get_app_catalogs_mapping_schema_product_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_app_catalogs_mapping_schema_product" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_app_catalogs_mapping_schema_product`")  # noqa: E501
    ...
    def put_app_catalogs_mapping_schema_product(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_app_catalogs_mapping_schema_product(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Catalog ID (required)
        :param MappingschemasProductBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_app_catalogs_mapping_schema_product_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_app_catalogs_mapping_schema_product_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_app_catalogs_mapping_schema_product_with_http_info(self, id, **kwargs):  # noqa: E501
        """Create or update the product mapping schema related to a catalog  # noqa: E501

        This endpoint allows you to create or update the product mapping schema related to a catalog  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_app_catalogs_mapping_schema_product_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_app_catalogs_mapping_schema_product" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `put_app_catalogs_mapping_schema_product`")  # noqa: E501
