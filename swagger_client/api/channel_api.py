...
class ChannelApi(object):
    ...
    def channels_patch(self, body, code, **kwargs):  # noqa: E501
        ...
        >>> thread = api.channels_patch(body, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ChannelsCodeBody body: (required)
        ...
        if kwargs.get('async_req'):
            return self.channels_patch_with_http_info(body, code, **kwargs)  # noqa: E501
        else:
            (data) = self.channels_patch_with_http_info(body, code, **kwargs)  # noqa: E501
            return data

    def channels_patch_with_http_info(self, body, code, **kwargs):  # noqa: E501
        """Update/create a channel  # noqa: E501

        This endpoint allows you to update a given channel. Know more about <a href=\"/documentation/update.html#update-behavior\">Update behavior</a>. Note that if no channel exists for the given code, it creates it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_patch_with_http_info(body, code, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `channels_patch`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `channels_patch`")  # noqa: E501
    ...
    def channels_post(self, **kwargs):  # noqa: E501
        """Create a new channel  # noqa: E501

        This endpoint allows you to create a new channel.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1ChannelsBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.channels_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.channels_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def channels_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new channel  # noqa: E501

        This endpoint allows you to create a new channel.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_channels_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_channels_code" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_channels_code`")  # noqa: E501
    ...
    def several_channels_patch(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.several_channels_patch(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1ChannelsBody1 body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.several_channels_patch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.several_channels_patch_with_http_info(**kwargs)  # noqa: E501
            return data

    def several_channels_patch_with_http_info(self, **kwargs):  # noqa: E501
        """Update/create several channels  # noqa: E501

        This endpoint allows you to update and/or create several channels at once.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.several_channels_patch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method several_channels_patch" % key
                )
            params[key] = val
        del params['kwargs']
