...
class VariantsCodeBody(object):
    ...
    def __init__(self, code=None, variant_attribute_sets=None, labels=None):  # noqa: E501
        """VariantsCodeBody - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    @property
    def code(self):
        """Gets the code of this VariantsCodeBody.  # noqa: E501

        Family variant code  # noqa: E501

        :return: The code of this VariantsCodeBody.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this VariantsCodeBody.

        Family variant code  # noqa: E501

        :param code: The code of this VariantsCodeBody.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def variant_attribute_sets(self):
        """Gets the variant_attribute_sets of this VariantsCodeBody.  # noqa: E501

        Attributes distribution according to the enrichment level  # noqa: E501

        :return: The variant_attribute_sets of this VariantsCodeBody.  # noqa: E501
    ...
    def variant_attribute_sets(self, variant_attribute_sets):
        """Sets the variant_attribute_sets of this VariantsCodeBody.

        Attributes distribution according to the enrichment level  # noqa: E501

        :param variant_attribute_sets: The variant_attribute_sets of this VariantsCodeBody.  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this VariantsCodeBody.  # noqa: E501


        :return: The labels of this VariantsCodeBody.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this VariantsCodeBody.


        :param labels: The labels of this VariantsCodeBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VariantsCodeBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VariantsCodeBody):
            return False
